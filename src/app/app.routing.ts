  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'grouting',
        // loadChildren: './routes/task/task.module#TaskModule',
        loadChildren: () => import('./routes/grouting/grouting.module').then(m => m.GroutingModule),
        data: { title: '压浆' },
        canDeactivate: [GlobalEditGuard]
      },
      {
      ...
      },
      {
        ...
        // loadChildren: './routes/setting/setting.module#SettingModule',
        loadChildren: () => import('./routes/grouting-setting/grouting-setting.module').then(m => m.GroutingSettingModule),
        data: { title: '压浆设置' }
      },
      {
        path: 'jack',

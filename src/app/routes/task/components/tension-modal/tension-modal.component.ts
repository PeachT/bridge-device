...
@Component({
  ...
  selector: 'task-tension-modal',
  templateUrl: './tension-modal.component.html',
  styleUrls: ['./tension-modal.component.less'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class TensionModalComponent implements OnInit {
  @Input() show: boolean;
